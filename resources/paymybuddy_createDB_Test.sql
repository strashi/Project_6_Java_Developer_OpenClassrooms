...
-- -----------------------------------------------------
-- Table `pmbTest_db`.`hibernate_sequence`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pmbTest_db`.`hibernate_sequence` (
...
-- -----------------------------------------------------
-- Table `pmbTest_db`.`persistent_logins`
-- -----------------------------------------------------
CREATE TABLE IF NOT EXISTS `pmbTest_db`.`persistent_logins` (
...
CREATE TABLE IF NOT EXISTS `pmbTest_db`.`relationship` (
  ...
  CONSTRAINT `FK4rhmk0nc3ctlnmvpbjr4cc6tn`
    ...
    REFERENCES `pmbTest_db`.`user` (`user_id`),
...
CREATE TABLE IF NOT EXISTS `pmbTest_db`.`user_bank_accounts` (
  ...
  CONSTRAINT `FKt2ony5uidj9voggaqlnwwghf5`
    ...
    REFERENCES `pmbTest_db`.`bank_account` (`bank_account_id`))
ENGINE = InnoDB
DEFAULT CHARACTER SET = utf8mb4
COLLATE = utf8mb4_0900_ai_ci;
