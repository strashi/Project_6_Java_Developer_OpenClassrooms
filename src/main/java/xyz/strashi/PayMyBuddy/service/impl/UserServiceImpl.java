...
/**
 * At first the admin is created when he doesn't already exist, with datas from
	...
	public User updateUser(User user, Principal principal) {
		...
		try {
			...
			if (optionalUser.isPresent()) {
				...
				// Si oui on teste si l'id de l utilisateur actuellement connecté est le même
				// que l'id correspondant
